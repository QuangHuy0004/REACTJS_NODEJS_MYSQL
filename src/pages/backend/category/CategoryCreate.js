            ...
            <div className='row py-3'>
                <div className='col-md-4'>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="namecategory" placeholder="Nhập tên danh mục" />
                    </div>
                    <div className="mb-3">
                        <p ><b>Mô tả</b></p>
                    ...
                    <div className='mb-3'>
                        <p ><b>Danh mục cha</b></p>
                        <select id="categoryFather" className="form-select">
