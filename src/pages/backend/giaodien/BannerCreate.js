...
const BannerCreate = () => {
    return (
        <div style={{ backgroundColor: "#f2f2f2" }}>
            <h3 className='py-3'>Thêm trang đơn</h3>
            <div className='text-end pe-4'>
                <Link to="/admin/banner" className='btn btn-primary'><FaArrowLeft className='fs-5 me-2 pb-1' />Về danh sách</Link>
            </div>
            <div className='row py-3'>
                ...
                <div className='col-md-3 pe-5 '>
                    ...
                    <div className='row bg-white'>
                        <p className='py-1 m-0' style={{ borderBottom: "2px solid #f2f2f2" }}><b>Vị trí (*)</b></p>
                        <div className='py-2' >
                            <select class="form-select" aria-label="Default select example" >
                            ...
                            <p className='py-1 m-0'>Vị trí hiển thị banner</p>
                        </div>
                    </div>
                    <div className='row bg-white mt-3'>
                        <p className='py-1 m-0' style={{ borderBottom: "1px solid #f2f2f2" }}><b>Hình</b></p>
                        <div className='py-2'>
